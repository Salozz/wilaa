...
def is_user_requesting_report_llm(text: str) -> bool:
    ...
    try:
        response = llm_internal.invoke([
            HumanMessage(content=(
                f"The user said: \"{text.strip()}\"\n"
                "Is the user asking to view or asking you to show or display a scan report, scan results, or any summary from tools like Nmap, Nikto, Dirsearch, a multi-tool scan or a full scan?\n"
